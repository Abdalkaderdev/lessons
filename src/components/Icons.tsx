...
export function BriefcaseIcon({ className, size = 24, color = "currentColor" }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function ArrowRightIcon({ className, size = 16, color = "currentColor" }: IconProps) {
  return (
...
export function StudentIcon({ icon, ...props }: IconProps & { icon: string }) {
  const Component = iconMap[icon] || SparkleIcon;
